...
if( ! function_exists( 'reverie_enqueue_style' ) ) {
	function reverie_enqueue_style()
	{
		...
		// Register the parent style
		wp_register_style( 'reverie-stylesheet', get_stylesheet_directory_uri() . '../reverie-master/css/style.css', array(), '', 'all' );
		
		// Register the child style
		wp_register_style( 'daily-stylesheet', get_stylesheet_directory_uri() . '/css/style.css', array(), '', 'all' );
		

		wp_enqueue_style( 'reverie-foundation-stylesheet' );
		wp_enqueue_style( 'reverie-stylesheet' );
		wp_enqueue_style( 'daily-stylesheet' ); 
