<?php if ( '-1' != of_get_option( 'category_portfolio' ) ) { ?>
...
<div class="portfolio-wrap">
	...
	<!-- BEGIN .portfolio -->
	<div class="portfolio <?php if (of_get_option( 'portfolio_columns' ) == 'two') { ?>portfolio-half<?php } if (of_get_option( 'portfolio_columns' ) == 'three') { ?>portfolio-third<?php } if (of_get_option( 'portfolio_columns' ) == 'four') { ?>portfolio-fourth<?php } ?>">
				...
				<div class="post-holder">
					...
					<?php } else { ?>
						<?php if ( '' != get_the_post_thumbnail()) { ?>
							<a class="feature-img" href="<?php the_permalink(); ?>" rel="bookmark" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'organicthemes' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_post_thumbnail( 'response-feature' ); ?></a>
						<?php } ?>
					<?php } ?>
