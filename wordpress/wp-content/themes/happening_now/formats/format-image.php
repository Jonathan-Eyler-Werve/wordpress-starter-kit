<?php if ( '' != get_the_post_thumbnail() ) { $thumb = wp_get_attachment_image_src(get_post_thumbnail_id(), ''); } ?>

<?php if ( '' != get_the_post_thumbnail() ) { ?>
    <a class="feature-img" href="<?php echo $thumb[0]; ?>"><?php the_post_thumbnail( 'response-feature' ); ?></a>
<?php } ?>
